...
Using the serial interface in the Arduino IDE you are able to control the digital I/O pins on the nano by typing the letter or [characters](main/README.md#control-lines) of the control line you wish to enable/disable. By doing so you can debug efficiently and test each individual operation.
